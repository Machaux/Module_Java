...
public class CompteCourant {
	...
	/** 
	 * Le setteur de Solde n'est pas judicieux car le solde est modifié par d'autres méthode et non fixé arbitrairement
	 * 
...
//	}
	...
	/** 
	 * le nombre de compte courant ne peut être implémenté que par le constructeur!!
	 * 
